...
local myData = {
	...
	loc2 = {
		...
		Location = { AtlasCategLocale["loc2loc"], 1637 };
		{ _RED.."A) "..AtlasCategLocale["Cartel_pos"], NPC, 900002 };
	...
	loc10 = {
		...
		Location = { AtlasCategLocale["SegodnyaTvoiLubimiiTorgPosec_loc"], 1637 };
		{ _RED.."A) "..AtlasCategLocale["Cartel_pos"], NPC, 900002 };
	...
	-- EtiBezLudIzAlogoOrden = {
	-- 	ZoneName = { AtlasCategLocale["EtiBezLudIzAlogoOrden"] };
	-- 	Location = { AtlasCategLocale["EtiBezLudIzAlogoOrden_loc"], 1637 };
	-- 	{ _RED.."A) "..AtlasCategLocale["Cartel_pos"], NPC, 900002 };
